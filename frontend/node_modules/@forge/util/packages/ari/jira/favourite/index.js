...
__export(favourite_exports, {
  ...
  JiraFavouriteAriResourceOwner: () => JiraFavouriteAriResourceOwner,
  JiraFavouriteAriResourceType: () => JiraFavouriteAriResourceType
});
module.exports = __toCommonJS(favourite_exports);
