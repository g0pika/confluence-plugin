...
__export(design_exports, {
  ...
  GraphDesignAriResourceOwner: () => GraphDesignAriResourceOwner,
  GraphDesignAriResourceType: () => GraphDesignAriResourceType
});
module.exports = __toCommonJS(design_exports);
