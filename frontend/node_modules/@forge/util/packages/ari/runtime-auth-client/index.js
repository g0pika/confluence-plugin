...
// src/runtime-auth-client/index.ts
var runtime_auth_client_exports = {};
__export(runtime_auth_client_exports, {
  RuntimeAuthClientRoleAri: () => RuntimeAuthClientRoleAri
});
module.exports = __toCommonJS(runtime_auth_client_exports);
