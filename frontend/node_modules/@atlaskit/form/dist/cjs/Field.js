...
var Field_1 = tslib_1.__importStar(require("./styled/Field"));
...
exports.FieldId = react_1.default.createContext(undefined);
function usePreviousRef(current) {
    var ref = react_1.useRef(current);
...
function Field(props) {
    var registerField = react_1.useContext(Form_1.FormContext);
    var isDisabled = react_1.useContext(Form_1.IsDisabledContext) || props.isDisabled;
    ...
    react_1.useEffect(function () {
        if (process.env.NODE_ENV !== 'production' && !process.env.CI) {
            tiny_invariant_1.default(latestPropsRef.current.name, '@atlaskit/form: Field components have a required name prop');
        }
    ...
    var fieldId = react_1.useMemo(function () { return (props.id ? props.id : props.name + "-" + react_uid_1.uid({ id: props.name })); }, [props.id, props.name]);
    var extendedFieldProps = tslib_1.__assign(tslib_1.__assign({}, state.fieldProps), { name: props.name, isDisabled: isDisabled, isInvalid: Boolean(state.error), isRequired: Boolean(props.isRequired), 'aria-invalid': (state.error ? 'true' : 'false'), 'aria-labelledby': fieldId + "-label " + fieldId + "-helper " + fieldId + "-valid " + fieldId + "-error", id: fieldId });
    return (react_1.default.createElement(Field_1.default, null,
        props.label && (react_1.default.createElement(Field_1.Label, { id: fieldId + "-label", htmlFor: fieldId },
            props.label,
            props.isRequired && (react_1.default.createElement(Field_1.RequiredIndicator, { "aria-hidden": "true" }, "*")))),
        react_1.default.createElement(exports.FieldId.Provider, { value: fieldId }, props.children({
