...
const getLineHeight = ({ isCompact }) => isCompact ? lineHeightCompact : lineHeightBase;
...
const getMinimumRowsHeight = ({ minimumRows = 1, isCompact }) => {
...
export const TextAreaWrapper = styled.div `
  ...
  & > textarea {
    ...
    border: 0;
    box-sizing: border-box;
    color: ${({ isDisabled, textColor, disabledRules }) => isDisabled ? disabledRules.textColor : textColor};
    ${({ isDisabled }) => (isDisabled ? 'pointer-events: none;' : null)}
    cursor: inherit;
    font-family: ${props => props.isMonospaced ? codeFontFamily() : 'inherit'};
    font-size: inherit;
    line-height: ${({ isCompact }) => getLineHeight({ isCompact }) / fontSize()};
    min-width: 0;
    outline: none;
    overflow: auto;
    max-width: 100%;
