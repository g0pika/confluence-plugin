...
declare type TabItemInnerRef = (ref: HTMLElement) => void;
...
export declare type TabItemType = ComponentType<TabItemComponentProvided>;
export declare type TabContentType = ComponentType<TabContentComponentProvided>;
export declare type SelectedProp = any;
export declare type IsSelectedTestFunction = (selected: SelectedProp, tab: TabData, tabIndex: number) => boolean;
export declare type OnSelectCallback = (selected: TabData, selectedIndex: number) => void;
