...
exports.defaultAttributesFn = function (p) { return ({}); };
exports.createExtender = function createExtender(defaults, 
...
overrides) {
    ...
    return function getOverrides(key) {
        var _a = defaults[key], defaultCssFn = _a.cssFn, defaultComponent = _a.component;
        if (!overrides[key]) {
            return {
                cssFn: defaultCssFn,
        ...
        var _b = overrides[key], customCssFn = _b.cssFn, customComponent = _b.component;
