...
var TransitionHandler = /** @class */ (function (_super) {
    ...
    function TransitionHandler() {
        ...
        _this.onEntered = function (node, isAppearing) {
            ...
            if (onEntered) {
                ...
                _this.enterTimeout = setTimeout(function () { return onEntered(node, isAppearing); }, constants_2.transitionDurationMs);
            }
        };
        _this.clearEnterTimeout = function () {
    ...
    TransitionHandler.prototype.componentWillUnmount = function () {
        this.clearEnterTimeout();
    };
    TransitionHandler.prototype.render = function () {
        var _a = this.props, _b = _a.component, component = _b === void 0 ? 'div' : _b, inProp = _a.in, onExited = _a.onExited, onEntered = _a.onEntered, defaultStyles = _a.defaultStyles, transitionStyles = _a.transitionStyles, transitionProps = _a.transitionProps, props = tslib_1.__rest(_a, ["component", "in", "onExited", "onEntered", "defaultStyles", "transitionStyles", "transitionProps"]);
        var timeout = {
            enter: 0,
            exit: constants_2.transitionDurationMs,
        };
        return (react_1.default.createElement(react_transition_group_1.Transition, tslib_1.__assign({ in: inProp, onExited: onExited, onExiting: this.clearEnterTimeout, onEntered: this.onEntered, timeout: timeout }, transitionProps), function (state) {
