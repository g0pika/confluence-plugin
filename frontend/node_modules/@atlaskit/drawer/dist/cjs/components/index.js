...
var DrawerBase = /** @class */ (function (_super) {
    ...
    DrawerBase.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_transition_group_1.Transition, { in: isOpen, timeout: { enter: 0, exit: constants_1.transitionDurationMs }, mountOnEnter: true, unmountOnExit: true },
                ...
                react_1.default.createElement(react_transition_group_1.TransitionGroup, { component: OnlyChild },
                    react_1.default.createElement(react_1.Fragment, null,
                        ...
                        react_1.default.createElement(focus_lock_1.default, { autoFocusFirstElem: autoFocusFirstElem, isFocusLockEnabled: isFocusLockEnabled, shouldReturnFocus: shouldReturnFocus },
                            react_1.default.createElement(primitives_1.default, { icon: icon, in: isOpen, onClose: this.handleBackButtonClick, onCloseComplete: onCloseComplete, onOpenComplete: onOpenComplete, width: width, shouldUnmountOnExit: shouldUnmountOnExit, overrides: overrides }, children)))))));
    };
