...
export declare const IconWrapper: ({ children, ...props }: IconProps) => JSX.Element;
export declare type RequiredIndicatorProps = {
    'aria-hidden'?: boolean | 'true' | 'false';
} & React.AllHTMLAttributes<HTMLSpanElement>;
export declare const RequiredIndicator: (props: RequiredIndicatorProps) => JSX.Element;
export {};
