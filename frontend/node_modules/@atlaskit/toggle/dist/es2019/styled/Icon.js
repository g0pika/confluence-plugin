...
`;
const Icon = ({ isChecked, size, }) => (React.createElement(IconWrapper, { size: size }, isChecked ? React.createElement(CheckIconSvg, null) : React.createElement(CrossIconSvg, null)));
export default Icon;
