...
export default function withSortedPageRows<WrappedComponentProps extends WithSortedPageRowsProps & Props>(WrappedComponent: React.ComponentType<WrappedComponentProps>): {
    ...
    getDerivedStateFromProps(props: Pick<WrappedComponentProps & Props, "head" | "page" | "rows" | "rowsPerPage" | "sortKey" | "sortOrder" | "onPageRowsUpdate" | Exclude<keyof WrappedComponentProps, "pageRows">>, state: {
        pageRows: RowType[];
    }): {
        pageRows: RowType[];
    };
