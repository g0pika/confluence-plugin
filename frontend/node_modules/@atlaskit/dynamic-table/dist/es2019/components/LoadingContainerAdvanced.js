...
export default class LoadingContainerAdvanced extends React.Component {
    constructor() {
        ...
        this.getThisNode = () => findDOMNode(this);
        // @ts-ignore - this.spinner is not assignable to type 'ReactInstance'
        this.getSpinnerNode = () => findDOMNode(this.spinner);
        ...
        if (isInViewport) {
            ...
            if (canFollow &&
                ...
                if (top >= 0) {
                    ...
                    const y = viewportSpaceTakenByElement < spinnerHeight * 3
                        ? top + spinnerHeight
                        : diff;
    ...
    render() {
        ...
        return (React.createElement(Container, null,
            ...
            isLoading && (React.createElement(SpinnerBackdrop, null,
                React.createElement(SpinnerContainer, { innerRef: (el) => {
                        this.spinner = el;
                    } },
