    ...
    DynamicTable.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(LoadingContainerAdvanced_1.default, { isLoading: isLoading && rowsExist, spinnerSize: spinnerSize, targetRef: function () { return _this.tableBody; } },
                react_1.default.createElement(DynamicTable_1.Table, { isFixedSize: isFixedSize, "data-testid": testId && testId + "--table" },
                    !!caption && react_1.default.createElement(DynamicTable_1.Caption, null, caption),
                    head && (react_1.default.createElement(TableHead_1.default, { head: head, onSort: this.onSort, sortKey: sortKey, sortOrder: sortOrder, isRanking: this.state.isRanking, isRankable: canRank, testId: testId })),
                    rowsExist &&
