...
var RankableBody = /** @class */ (function (_super) {
    ...
    RankableBody.prototype.render = function () {
        ...
        return (react_1.default.createElement(react_beautiful_dnd_1.DragDropContext, { onBeforeDragStart: this.onBeforeDragStart, onDragEnd: this.onDragEnd },
            react_1.default.createElement(react_beautiful_dnd_1.Droppable, { droppableId: "dynamic-table-droppable", isDropDisabled: isRankingDisabled }, function (provided) { return (react_1.default.createElement("tbody", tslib_1.__assign({ "data-testid": testId, ref: provided.innerRef }, provided.droppableProps),
