...
var Stateless_1 = tslib_1.__importDefault(require("./Stateless"));
var DynamicTable = /** @class */ (function (_super) {
    ...
    function DynamicTable() {
        ...
        _this.onSort = function (_a, analyticsEvent) {
            ...
            if (onSort) {
                ...
                _this.setState({ sortKey: key, sortOrder: sortOrder });
            }
        };
        ...
        _this.onRankEnd = function (params) {
            ...
            var reordered = helpers_1.reorderRows(params, rows, page, rowsPerPage);
            _this.setState({
                rows: reordered,
            });
            _this.onRankEndIfExists(params);
    ...
    DynamicTable.prototype.render = function () {
        ...
        var _b = this.props, caption = _b.caption, emptyView = _b.emptyView, head = _b.head, highlightedRowIndex = _b.highlightedRowIndex, loadingSpinnerSize = _b.loadingSpinnerSize, isLoading = _b.isLoading, isFixedSize = _b.isFixedSize, isRankable = _b.isRankable, isRankingDisabled = _b.isRankingDisabled, rowsPerPage = _b.rowsPerPage, paginationi18n = _b.paginationi18n, onRankStart = _b.onRankStart, onPageRowsUpdate = _b.onPageRowsUpdate, testId = _b.testId;
        return (react_1.default.createElement(Stateless_1.default, { paginationi18n: paginationi18n, caption: caption, emptyView: emptyView, head: head, highlightedRowIndex: highlightedRowIndex, loadingSpinnerSize: loadingSpinnerSize, isLoading: isLoading, isFixedSize: isFixedSize, onSetPage: this.onSetPage, onSort: this.onSort, page: page, rows: rows, rowsPerPage: rowsPerPage, sortKey: sortKey, sortOrder: sortOrder, isRankable: isRankable, isRankingDisabled: isRankingDisabled, onRankEnd: this.onRankEnd, onRankStart: onRankStart, onPageRowsUpdate: onPageRowsUpdate, testId: testId }));
    };
