...
exports.HeadCell = styled_components_1.default.th(templateObject_3 || (templateObject_3 = tslib_1.__makeTemplateObject(["\n  ", " \n  ", " \n  ", " \n  ", " \n  border: none;\n  color: ", ";\n  box-sizing: border-box;\n  font-size: 12px;\n  font-weight: 600;\n  position: relative;\n  text-align: left;\n  vertical-align: top;\n  &:focus {\n    outline: solid 2px ", ";\n  }\n"], ["\n  ", " \n  ", " \n  ", " \n  ", " \n  border: none;\n  color: ", ";\n  box-sizing: border-box;\n  font-size: 12px;\n  font-weight: 600;\n  position: relative;\n  text-align: left;\n  vertical-align: top;\n  &:focus {\n    outline: solid 2px ", ";\n  }\n"])), function (_a) {
    ...
    return constants_1.onClickStyle({ onClick: Boolean(onClick) });
}, function (p) { return constants_1.truncateStyle(p); }, function (p) { return constants_1.arrowsStyle(p); }, constants_1.cellStyle, theme_1.head.textColor, colors_1.B100);
