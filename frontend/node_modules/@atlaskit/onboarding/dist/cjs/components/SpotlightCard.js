...
var SpotlightCard = /** @class */ (function (_super) {
    ...
    SpotlightCard.prototype.render = function () {
        var _a = this.props, actions = _a.actions, actionsBeforeElement = _a.actionsBeforeElement, children = _a.children, components = _a.components, isFlat = _a.isFlat, heading = _a.heading, headingAfterElement = _a.headingAfterElement, image = _a.image, innerRef = _a.innerRef, theme = _a.theme, width = _a.width, testId = _a.testId;
        return (react_1.default.createElement(button_1.Theme.Provider, { value: theme_1.spotlightButtonTheme },
            react_1.default.createElement(Card_1.default, { testId: testId, ref: innerRef, heading: heading, headingAfterElement: headingAfterElement, actions: actions, actionsBeforeElement: actionsBeforeElement, components: components, image: image, theme: function (parent) {
