...
var Card = function (_a) {
    var _b = _a.actions, actions = _b === void 0 ? [] : _b, actionsBeforeElement = _a.actionsBeforeElement, children = _a.children, _c = _a.components, components = _c === void 0 ? {} : _c, image = _a.image, heading = _a.heading, headingAfterElement = _a.headingAfterElement, theme = _a.theme, innerRef = _a.innerRef, testId = _a.testId;
    ...
    return (react_1.default.createElement(Theme.Provider, { value: theme },
        react_1.default.createElement(Theme.Consumer, null, function (_a) {
            ...
            return (react_1.default.createElement(Container, { theme: container, innerRef: innerRef, "data-testid": testId },
