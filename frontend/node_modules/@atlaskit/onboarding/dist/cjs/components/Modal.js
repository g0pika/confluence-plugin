...
var OnboardingModal = /** @class */ (function (_super) {
    ...
    function OnboardingModal() {
        ...
        _this.footerComponent = function (props) {
            var FooterElement = props.footer, actionList = props.actions, _a = props.experimental_shouldShowPrimaryButtonOnRight, experimental_shouldShowPrimaryButtonOnRight = _a === void 0 ? false : _a;
            var ActionsElement = function () {
                return actionList ? (react_1.default.createElement(button_1.Theme.Provider, { value: theme_1.modalButtonTheme },
                    react_1.default.createElement(Modal_1.Actions, { shouldReverseButtonOrder: experimental_shouldShowPrimaryButtonOnRight }, actionList.map(function (_a, idx) {
